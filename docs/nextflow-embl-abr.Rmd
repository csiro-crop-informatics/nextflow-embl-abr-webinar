---
title: "Implementing Scalable Bioinformatic Workflows "
author:
- Rad Suchecki (CSIRO Crop Bioinformatics and Data Science)
- Nathan Watson-Haigh (University of Adelaide Bioinformatics Hub)
subtitle: "Nextflow"
...
[![https://www.nature.com/articles/d41586-019-02619-z](figs/wflows.jpg){ width=100% }](https://www.nature.com/articles/d41586-019-02619-z)

<small> [https://www.nature.com/articles/d41586-019-02619-z](https://www.nature.com/articles/d41586-019-02619-z) </small>
</div>
...
* Reinventing the wheel is pointless, but for computational biologists it’s sometimes unavoidable
* Large, complex code base of
  * “Bits had been bolted on in an ad hoc fashion over seven years by at least four different developers.”
  * “heavily tied to the compute infrastructure”
...
* So, do you need a workflow system?
  * Not every task requires one, and there is a learning curve.
  * Scripting usually suffices for one-off tasks and when working out the pipeline itself.
  * But The tipping point, most agree, comes when you need to run the same workflow over and over again, or if the data are likely to be published.

* Philip Ewels:
  * The languages are easy to pick up, and examples are abundant.
  * Once you’re familiar with it, you get in the habit of using it, **And then you wonder how you ever lived without it.**
